...
echo cc && mipsel-none-elf-gcc -c -fomit-frame-pointer -fno-stack-protector -G1 -O3 ${OPTFLAGS} -msoft-float -nostdlib -mips1 -march=3000 -o obj/main.o main.c && \
...
echo ld && mipsel-none-elf-ld -T link.ld -o obj/${EXE_NAME}.elf obj/head.o obj/main.o -L/usr/local/mipsel-none-elf/lib/soft-float/ -L/usr/local/lib/gcc/mipsel-none-elf/4.7.0/soft-float/ -lm -lc -lgcc && \
